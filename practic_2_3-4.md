...
## Некотрые встроенные функции для работы с массивами, функции для "нейтрального" программирования
...
Задачи 1-2. Реализовать эти две разновидности пузырьковой сортировки.
...
Задача 3. Написать функцию с заголовком
...
Задача 4. Пусть `perm` - это некоторый вектор перестановок индексов одномерного массива `A`. Написать свою реализац
...
Задача 5. Реализовать встроенные функции вставки/добавления (deleteat!, insert!) элемента массива
...
Задача 6. Реализовать встроенные функции `unique`, `unique!`, `allunique`

## Обращение последовательности

- `reverse(a) = a[end:-1:1]` # - это просто частный случай среза
- `reverse!`
- `reverseind(a,i)=length(a)-i+1`
  
Задача 7. Реализовать встроенную функцию reverse!, переставляющую элементы в обратном порядке в самом массиве, т.е. "на месте"
...
Задача 8. Реализовать  функцию, аналогичную встроенной функции transpose, с использованием вспомогательного массива

Задача 9. Реализовать функцию, аналогичную встроенной функции transpose, осуществляющую транспонирование матрицы "на месте" (без использования вспомогательного массива)
